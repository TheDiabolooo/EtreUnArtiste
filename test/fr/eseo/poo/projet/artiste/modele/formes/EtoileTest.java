...
public class EtoileTest {
	...
	public void testSetNombresBranchesFaux1() {
		...
		try {
			...
			assertTrue(e.getMessage().equals("Une étoile peut avoir entre 3 et 15 branches."));
		}
	}
	...
	public void testSetLongueurBranchesFaux1() {
		...
		try {
			...
			assertTrue(e.getMessage().equals("La longueur des branches des branches d'une étoile "
	...
	public void testAnglePremiereBrancheFaux1() {
		...
		try {
			...
			assertTrue(e.getMessage().equals("L’angle formé entre la première branche et "
	...
	public void testContientPas() {
		Coordonnees a = new Coordonnees(1,1);
		Etoile e1 = new Etoile();
